...
/** Free preview rows; full board unlocked with diamonds (~₹39 at tier-1 rate) */
const PK_LEADERBOARD_PREVIEW_COUNT = 3;
const PK_LEADERBOARD_UNLOCK_INR = 39;
const PK_LEADERBOARD_UNLOCK_DIAMONDS = Math.round(
  PK_LEADERBOARD_UNLOCK_INR * (13800 / 272),
);
