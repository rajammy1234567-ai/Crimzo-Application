...
const DEFAULT_TASKS = [
  ...
  { key: 'daily_live_message', title: 'Send a message in 1 Live room(s)', section: 'daily', reward_type: 'beans', reward_amount: 10, max_count: 5, action_type: 'manual', deep_link: '/(tabs)/home', sort_order: 10 },
  { key: 'daily_like_moment', title: 'Like 2 moment(s) of others', section: 'daily', reward_type: 'beans', reward_amount: 10, max_count: 5, action_type: 'manual', deep_link: '/(tabs)/reels', sort_order: 11 },
