...
export const LEVEL_CATALOG: LevelCatalogEntry[] = [
  ...
  { level_number: 4, name: 'Royal', description: 'Raja ka Rath — royal entry guaranteed.', price_diamonds: 5000, showcase_type: 'rath', showcase_model_key: 'golf_gti_v3', showcase_emoji: '🐎', badge_color: '#A855F7' },
  { level_number: 5, name: 'Elite', description: 'Supercar status — elite showcase.', price_diamonds: 15000, showcase_type: 'supercar', showcase_model_key: 'golf_gti_v2', showcase_emoji: '🏎️', badge_color: '#F59E0B' },
